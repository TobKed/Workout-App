class Workout(object):
    """  workout class
        ...
        plan -   list of  repetitions and time for each excercise and set
               ...
               plan[e][0] - exercise e name
               plan[e][1] - exercise e matrix
               plan[e][1][s] - exercise e set s  list of blocks [reps, time]
               plan[e][1][s][0] - exercise e set s repetetions r
               plan[e][1][s][1] - exercise e set s time t

        break_excercise -   break between exercises in set (s)
    ...
    def GetExcerciseName(self, ex_nr, set):
        return self.plan[ex_nr][0][set]
