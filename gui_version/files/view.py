...
class Timer:
    def __init__(self, master):
        ...
        self.text_plus_1_position = 0.63
        
        self.text_plus_2_size = 10
        self.text_plus_2_color = "white"
        self.text_plus_2_font = {"font": "Helvetica", "style": "bold"}
        self.text_plus_2_position = 0.75
        
        self.text_minus_1_size = 15
        ...
        self.text_minus_2_position = 0.3
    ...
    def text_plus_1_coords(self):
        return int(self.canvas_size / 2), int(self.canvas_size * (1-self.text_plus_1_position))
    ...
    def text_plus_2_coords(self):
        return int(self.canvas_size / 2), int(self.canvas_size * (1-self.text_plus_2_position))
    ...
    def text_minus_1_coords(self):
        return int(self.canvas_size / 2), int(self.canvas_size * (1-self.text_minus_1_position))
    ...
    def text_minus_2_coords(self):
        return int(self.canvas_size / 2), int(self.canvas_size * (1-self.text_minus_2_position))
